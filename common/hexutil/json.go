...
// MarshalSDXText implements encoding.TextMarshaler
// func (b Bytes) MarshalSDXText() ([]byte, error) {
...
func bytesHaveSDXPrefix(input []byte) bool {
