...
const LAbstractSDXXListingABI = "[{\"constant\":true,\"inputs\":[{\"name\":\"\",\"type\":\"address\"}],\"name\":\"getTokenStatus\",\"outputs\":[{\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"}]"
...
func DeployLAbstractSDXXListing(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *LAbstractSDXXListing, error) {
	parsed, err := abi.JSON(strings.NewReader(LAbstractSDXXListingABI))
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	address, tx, contract, err := bind.DeployContract(auth, parsed, common.FromHex(LAbstractSDXXListingBin), backend)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &LAbstractSDXXListing{LAbstractSDXXListingCaller: LAbstractSDXXListingCaller{contract: contract}, LAbstractSDXXListingTransactor: LAbstractSDXXListingTransactor{contract: contract}, LAbstractSDXXListingFilterer: LAbstractSDXXListingFilterer{contract: contract}}, nil
}
...
// LAbstractSDXXListingSession is an auto generated Go binding around an Ethereum contract,
// with pre-set call and transact options.
...
// LAbstractSDXXListingCallerSession is an auto generated read-only Go binding around an Ethereum contract,
// with pre-set call options.
...
// LAbstractSDXXListingTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
// with pre-set transact options.
...
func NewLAbstractSDXXListing(address common.Address, backend bind.ContractBackend) (*LAbstractSDXXListing, error) {
	contract, err := bindLAbstractSDXXListing(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &LAbstractSDXXListing{LAbstractSDXXListingCaller: LAbstractSDXXListingCaller{contract: contract}, LAbstractSDXXListingTransactor: LAbstractSDXXListingTransactor{contract: contract}, LAbstractSDXXListingFilterer: LAbstractSDXXListingFilterer{contract: contract}}, nil
}
...
func NewLAbstractSDXXListingCaller(address common.Address, caller bind.ContractCaller) (*LAbstractSDXXListingCaller, error) {
	contract, err := bindLAbstractSDXXListing(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &LAbstractSDXXListingCaller{contract: contract}, nil
}
...
func NewLAbstractSDXXListingTransactor(address common.Address, transactor bind.ContractTransactor) (*LAbstractSDXXListingTransactor, error) {
	contract, err := bindLAbstractSDXXListing(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &LAbstractSDXXListingTransactor{contract: contract}, nil
}
...
func NewLAbstractSDXXListingFilterer(address common.Address, filterer bind.ContractFilterer) (*LAbstractSDXXListingFilterer, error) {
	contract, err := bindLAbstractSDXXListing(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &LAbstractSDXXListingFilterer{contract: contract}, nil
}

// bindLAbstractSDXXListing binds a generic wrapper to an already deployed contract.
func bindLAbstractSDXXListing(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(LAbstractSDXXListingABI))
	if err != nil {
		return nil, err
	}
...
func (_LAbstractSDXXListing *LAbstractSDXXListingRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _LAbstractSDXXListing.Contract.LAbstractSDXXListingCaller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_LAbstractSDXXListing *LAbstractSDXXListingRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _LAbstractSDXXListing.Contract.LAbstractSDXXListingTransactor.contract.Transfer(opts)
}
...
func (_LAbstractSDXXListing *LAbstractSDXXListingRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _LAbstractSDXXListing.Contract.LAbstractSDXXListingTransactor.contract.Transact(opts, method, params...)
}
...
func (_LAbstractSDXXListing *LAbstractSDXXListingCallerRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _LAbstractSDXXListing.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_LAbstractSDXXListing *LAbstractSDXXListingTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _LAbstractSDXXListing.Contract.contract.Transfer(opts)
}
...
func (_LAbstractSDXXListing *LAbstractSDXXListingTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _LAbstractSDXXListing.Contract.contract.Transact(opts, method, params...)
}
...
func (_LAbstractSDXXListing *LAbstractSDXXListingCaller) GetTokenStatus(opts *bind.CallOpts, arg0 common.Address) (bool, error) {
	...
	out := ret0
	err := _LAbstractSDXXListing.contract.Call(opts, out, "getTokenStatus", arg0)
	return *ret0, err
}
...
func (_LAbstractSDXXListing *LAbstractSDXXListingSession) GetTokenStatus(arg0 common.Address) (bool, error) {
	return _LAbstractSDXXListing.Contract.GetTokenStatus(&_LAbstractSDXXListing.CallOpts, arg0)
}
...
const LAbstractTokenSRC21ABI = "[{\"constant\":true,\"inputs\":[],\"name\":\"issuer\",\"outputs\":[{\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"}]"
...
func DeployLAbstractTokenSRC21(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *LAbstractTokenSRC21, error) {
	parsed, err := abi.JSON(strings.NewReader(LAbstractTokenSRC21ABI))
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	address, tx, contract, err := bind.DeployContract(auth, parsed, common.FromHex(LAbstractTokenSRC21Bin), backend)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &LAbstractTokenSRC21{LAbstractTokenSRC21Caller: LAbstractTokenSRC21Caller{contract: contract}, LAbstractTokenSRC21Transactor: LAbstractTokenSRC21Transactor{contract: contract}, LAbstractTokenSRC21Filterer: LAbstractTokenSRC21Filterer{contract: contract}}, nil
}
...
// LAbstractTokenSRC21Session is an auto generated Go binding around an Ethereum contract,
// with pre-set call and transact options.
...
// LAbstractTokenSRC21CallerSession is an auto generated read-only Go binding around an Ethereum contract,
// with pre-set call options.
...
// LAbstractTokenSRC21TransactorSession is an auto generated write-only Go binding around an Ethereum contract,
// with pre-set transact options.
...
func NewLAbstractTokenSRC21(address common.Address, backend bind.ContractBackend) (*LAbstractTokenSRC21, error) {
	contract, err := bindLAbstractTokenSRC21(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &LAbstractTokenSRC21{LAbstractTokenSRC21Caller: LAbstractTokenSRC21Caller{contract: contract}, LAbstractTokenSRC21Transactor: LAbstractTokenSRC21Transactor{contract: contract}, LAbstractTokenSRC21Filterer: LAbstractTokenSRC21Filterer{contract: contract}}, nil
}
...
func NewLAbstractTokenSRC21Caller(address common.Address, caller bind.ContractCaller) (*LAbstractTokenSRC21Caller, error) {
	contract, err := bindLAbstractTokenSRC21(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &LAbstractTokenSRC21Caller{contract: contract}, nil
}
...
func NewLAbstractTokenSRC21Transactor(address common.Address, transactor bind.ContractTransactor) (*LAbstractTokenSRC21Transactor, error) {
	contract, err := bindLAbstractTokenSRC21(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &LAbstractTokenSRC21Transactor{contract: contract}, nil
}
...
func NewLAbstractTokenSRC21Filterer(address common.Address, filterer bind.ContractFilterer) (*LAbstractTokenSRC21Filterer, error) {
	contract, err := bindLAbstractTokenSRC21(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &LAbstractTokenSRC21Filterer{contract: contract}, nil
}

// bindLAbstractTokenSRC21 binds a generic wrapper to an already deployed contract.
func bindLAbstractTokenSRC21(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(LAbstractTokenSRC21ABI))
	if err != nil {
		return nil, err
	}
...
func (_LAbstractTokenSRC21 *LAbstractTokenSRC21Raw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _LAbstractTokenSRC21.Contract.LAbstractTokenSRC21Caller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_LAbstractTokenSRC21 *LAbstractTokenSRC21Raw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _LAbstractTokenSRC21.Contract.LAbstractTokenSRC21Transactor.contract.Transfer(opts)
}
...
func (_LAbstractTokenSRC21 *LAbstractTokenSRC21Raw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _LAbstractTokenSRC21.Contract.LAbstractTokenSRC21Transactor.contract.Transact(opts, method, params...)
}
...
func (_LAbstractTokenSRC21 *LAbstractTokenSRC21CallerRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _LAbstractTokenSRC21.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_LAbstractTokenSRC21 *LAbstractTokenSRC21TransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _LAbstractTokenSRC21.Contract.contract.Transfer(opts)
}
...
func (_LAbstractTokenSRC21 *LAbstractTokenSRC21TransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _LAbstractTokenSRC21.Contract.contract.Transact(opts, method, params...)
}
...
func (_LAbstractTokenSRC21 *LAbstractTokenSRC21Caller) Issuer(opts *bind.CallOpts) (common.Address, error) {
	...
	out := ret0
	err := _LAbstractTokenSRC21.contract.Call(opts, out, "issuer")
	return *ret0, err
}
...
func (_LAbstractTokenSRC21 *LAbstractTokenSRC21Session) Issuer() (common.Address, error) {
	return _LAbstractTokenSRC21.Contract.Issuer(&_LAbstractTokenSRC21.CallOpts)
}
...
func (_Lending *LendingCaller) SdxXListing(opts *bind.CallOpts) (common.Address, error) {
	...
	out := ret0
	err := _Lending.contract.Call(opts, out, "SdxXListing")
	return *ret0, err
}
...
func (_Lending *LendingSession) SdxXListing() (common.Address, error) {
	return _Lending.Contract.SdxXListing(&_Lending.CallOpts)
}
