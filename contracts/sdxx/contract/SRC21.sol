...
/**
 * @title Standard SRC21 token
 * @dev Implementation of the basic standard token.
 */
contract SRC21 is ISRC21 {
...
contract MySRC21 is SRC21 {
    ...
    constructor (address[] _owners,
                ...
                ) SRC21(_name, _symbol, _decimals) public validRequirement(_owners.length, _required) {
