...
func (w *wizard) makeGenesis() {
	...
	case choice == "" || choice == "3":
		...
		genesis.Config.DPoS.Period = uint64(w.readDefaultInt(2))

		fmt.Println()
		fmt.Println("How many SDX should be rewarded to masternode? (default = 5000)")
		genesis.Config.DPoS.Reward = uint64(w.readDefaultInt(5000))
		...
		genesis.Config.DPoS.Epoch = epochNumber
		...
		genesis.Config.DPoS.FoudationWalletAddr = w.readDefaultAddress(common.HexToAddress(common.FoudationAddr))
